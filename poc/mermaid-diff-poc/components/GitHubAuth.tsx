...
export default function GitHubAuth({ onAuthenticated }: GitHubAuthProps) {
  ...
  return (
    <div className="max-w-md mx-auto mt-20 p-8 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700">
      <div className="text-center mb-6">
        <svg className="w-16 h-16 mx-auto mb-4 text-slate-700 dark:text-slate-300" fill="currentColor" viewBox="0 0 24 24">
        ...
        <p className="text-slate-600 dark:text-slate-400 text-sm">
          Enter your personal access token to browse repositories
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
          <p className="text-xs text-blue-800 dark:text-blue-300">
            ...
            3. Generate new token → Select "repo" scope<br/>
